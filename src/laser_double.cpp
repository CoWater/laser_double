...
public:
	SyncerNode() : Node("syncer") {
		...
		this->declare_parameter("scan1_topic", "/lidar1/scan");
		this->get_parameter("scan1_topic", scan1_topic_);
		this->declare_parameter("scan2_topic", "/lidar2/scan");
		this->get_parameter("scan2_topic", scan2_topic_);
		this->declare_parameter("scan_topic", "/scan");
		this->get_parameter("scan_topic", scan_topic_);
		this->declare_parameter("lidar1_rotate", -135.0);
		...
		this->declare_parameter("lidar1_yoffset", -0.235);
		this->get_parameter("lidar1_yoffset", lidar1_yoffset);
		this->declare_parameter("lidar2_rotate", 45.0);
		...
		this->declare_parameter("lidar2_yoffset", 0.235);
